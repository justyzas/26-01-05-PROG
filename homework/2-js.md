### 2.1 Informacija apie skaičių

Su `prompt` funkcijos pagalba paprašykite vartotojo įvesti skaičių.
Gautą įvestį paverskite skaičiumi ir konsolėje pateikite aprašymą apie šį skaičių paminėdami šiuos dalykus:
